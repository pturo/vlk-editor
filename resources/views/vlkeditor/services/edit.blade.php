...
@section('content')
    <div class="container">
        ...
        <p>
            Edycja usługi jest bardzo prosta. Wybierz konkretne pole do edycji,
            a następnie wprowadź zmiany. Nie zapomnij zapisać zmian!
        </p>
            ...
            <div class="form-wrapper">
                <form action="{{ route('services.update', [$service->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-control">
                        ...
                        <textarea name="excerpt" id="excerpt" cols="30" rows="10">{{ $service->excerpt }}</textarea>
                    </div>
                    @error('excerpt')
                        <div class="msg-feedback-fail" role="alert">{{ $message }}</div>
                    @enderror
